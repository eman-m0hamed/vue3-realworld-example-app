<template>
  <div class="article-preview">
    <div class="article-meta">
      ...
      >
        <img :src="article.author.image" :alt="props.article.author.username"  @error="(e) => (e.target.src = 'https://thumbs.dreamstime.com/b/default-profile-picture-icon-high-resolution-high-resolution-default-profile-picture-icon-symbolizing-no-display-picture-360167031.jpg')">
      </AppLink>
      <div class="info">
        <AppLink
          name="profile"
